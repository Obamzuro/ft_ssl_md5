...
void			pf_uputnbr_common(t_unumber *n, char base,
		char top, t_buffer *buff);
unsigned char	pf_nbr_size(__intmax_t n, char base, char alternative);
unsigned char	pf_unbr_size(__uintmax_t n, char base, char alternative);
...
void			get_unsigned(t_special *spec, va_list *ap, __uintmax_t *n);
void			get_decimal(t_special *spec, va_list *ap, __intmax_t *n);
