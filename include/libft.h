...
size_t			ft_nbr_size(__intmax_t n);
size_t			ft_nbr_basesize(__intmax_t n, char base, char alternative);
size_t			ft_unbr_basesize(__uintmax_t n, char base, char alternative);
...
void			ft_strreverse(char *str, u_int64_t strlen);
